...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const temas = [
        ...
        "LAS ESTRELLAS", "CUIDADO DEL AGUA", "SEGUNDA GUERRA MUNDIAL", "ETNIAS - MAZAHUAS Y OTOMÍES", "LA CONSTITUCIÓN - 5 DE FEBRERO", 
        "ESTRUCTURA Y CAPAS DE LA TIERRA", "FLORA Y FAUNA DE MÉXICO","PLACAS TECTÓNICAS - SISMOS Y TEMBLORES", "DESIERTO", 
